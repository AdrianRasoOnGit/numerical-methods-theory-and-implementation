...
| Natural cubic spline | [Yes](docs/interpolation/natural_cubic_spline.md) | [`natural_cubic_spline.py`](python/nmti/interpolation/natural_cubic_spline.py) | [`natural_cubic_spline.jl`](julia/src/interpolation/natural_cubic_spline.jl) | [`natural_cubic_spline.f90`](fortran/src/interpolation/natural_cubic_spline.f90) |
| Clamped cubic spline | [Yes](docs/interpolation/clamped_cubic_spline.md) | [`clamped_cubic_spline.py`](python/nmti/interpolation/clamped_cubic_spline.py) | [`clamped_cubic_spline.jl`](julia/src/interpolation/clamped_cubic_spline.jl) | [`clamped_cubic_spline.f90`](fortran/src/interpolation/clamped_cubic_spline.f90) |
...
| Trapezoidal rule | No    | [`trapezoidal.py`](python/nmti/integration/trapezoidal.py)  | [`trapezoidal.jl`](julia/src/integration/trapezoidal.jl)  | [`trapezoidal.f90`](fortran/src/integration/trapezoidal.f90) |
| Simpson's rule | No | [`simpson.py`](python/nmti/integration/simpson.py) | [`simpson.jl`](julia/src/integration/simpson.jl) | [`simpson.f90`](fortran/src/integration/simpson.f90)  |
